...
//This test will check the for an entry above the upper bound of allowable collection frequency
...
WebUI.setText(findTestObject('Object Repository/Admin_Regions/DetailPaneFields/entry_Frequency'), '53')
