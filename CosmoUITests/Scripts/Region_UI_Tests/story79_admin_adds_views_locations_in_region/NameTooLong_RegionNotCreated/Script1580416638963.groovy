...
//This test will ensure the proper error message appears after entering a name is longer than the upper bound for region name
...
WebUI.setText(findTestObject('Object Repository/Admin_Regions/DetailPaneFields/entry_RegionName'), 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa')
