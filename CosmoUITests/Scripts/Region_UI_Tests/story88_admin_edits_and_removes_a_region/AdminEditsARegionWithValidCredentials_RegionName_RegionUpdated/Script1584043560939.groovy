...
/**
 * This tests the functionality of editing the Region Name for a particular Region
 * Authors: Aaron Atkinson cst201
 */

String newRegionName = "Midtown"

String orgRegionName = "A Past Region"
...
String newItemName =  WebUI.getText(findTestObject('Admin_Regions/RegionTable/td_Item5'));

WebUI.verifyMatch(newItemName,newRegionName , false)
