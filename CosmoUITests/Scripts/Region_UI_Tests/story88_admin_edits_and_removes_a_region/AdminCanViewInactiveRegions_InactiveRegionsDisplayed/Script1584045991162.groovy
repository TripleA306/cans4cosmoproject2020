...
/**
 * This tests the functionality of displaying all inactive Regions on the Regions table
...
WebUI.click(findTestObject('Object Repository/Admin_Regions/RegionTable/td_item1'))
...
//Switch the showall back to make future tests pass
WebUI.click(findTestObject('Object Repository/Admin_Regions/Buttons/Details/btn_ShowAll'))
