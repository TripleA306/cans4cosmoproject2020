...
//Verify is exited and no item is selected
WebUI.verifyElementPresent(findTestObject('Object Repository/Routes_OR/Route_Details/text_SelectRoute'),3)

//Check that the first route's date is different than stored, indicated route was removed
WebUI.verifyNotMatch(WebUI.getText(findTestObject('Object Repository/Routes_OR/Route_Table/RouteDates/table_R1_Date')), routeOneDate, false)
