...
WebUI.verifyElementPresent(findTestObject('Object Repository/Routes_OR/Route_Details/Delete_Modal/modal_headerDeleteRoute'), 5)
...
WebUI.click(findTestObject('Object Repository/Routes_OR/Route_Details/Delete_Modal/modal_btnOK'))

//verify that the confirm delete modal is no longer present
WebUI.verifyElementNotPresent(findTestObject('Object Repository/Routes_OR/Route_Details/Delete_Modal/modal_headerDeleteRoute'), 5)
Thread.sleep(2000)

//verify that the select route text box is present
WebUI.verifyElementPresent(findTestObject('Object Repository/Routes_OR/Route_Details/text_SelectRoute'), 5)
