...
WebUI.click(findTestObject('Object Repository/Routes_OR/Route_Details/Delete_Modal/modal_btnCancel'))

//verify that the confirm delete modal is no longer present
WebUI.verifyElementNotPresent(findTestObject('Object Repository/Routes_OR/Route_Details/Delete_Modal/modal_btnCancel'), 5)
WebUI.verifyElementNotPresent(findTestObject('Object Repository/Routes_OR/Route_Details/Delete_Modal/modal_btnOK'), 5)
WebUI.verifyElementNotPresent(findTestObject('Object Repository/Routes_OR/Route_Details/Delete_Modal/modal_RouteName'), 5)

//Verify That the Route item is still in same spot on table
WebUI.verifyElementText(findTestObject('Object Repository/Routes_OR/Route_Table/RouteName/table_R1_RouteName'), routeName)

//Verify details items are still present
WebUI.verifyElementPresent(findTestObject('Object Repository/Routes_OR/Route_Details/View_Mode/details_RouteNameInactive'),5)
WebUI.verifyElementPresent(findTestObject('Object Repository/Routes_OR/Route_Details/View_Mode/details_Region'),5)
WebUI.verifyElementPresent(findTestObject('Object Repository/Routes_OR/Route_Details/View_Mode/details_CompleteSwitchInactive'),5)
WebUI.verifyElementPresent(findTestObject('Object Repository/Routes_OR/Route_Details/View_Mode/details_DateInactive'),5)
