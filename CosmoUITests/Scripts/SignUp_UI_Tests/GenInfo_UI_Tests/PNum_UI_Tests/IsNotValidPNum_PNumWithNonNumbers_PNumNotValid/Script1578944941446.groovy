...
WebUI.setText(findTestObject('Object Repository/SignUp_OR/Text Inputs/txtPhoneNumber'), '1111A! 111')
...
WebUI.verifyElementText(findTestObject('SignUp_OR/Error Boxes/errorPhoneNumber'), 'Phone number can only contain numbers')
