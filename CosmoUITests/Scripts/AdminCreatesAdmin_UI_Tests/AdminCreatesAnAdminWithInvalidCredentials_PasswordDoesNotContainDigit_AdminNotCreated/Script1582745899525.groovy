...
/**
 * This tests the functionality of the Creating a New Admin with a password that does not contain any digits as invalid credentials
...
//Set the Password
WebUI.setText(findTestObject('Object Repository/AdminCreateAdmin_OR/ePassword'), 'Password')

//Confirm the Password
WebUI.setText(findTestObject('Object Repository/AdminCreateAdmin_OR/eConfirmPassword'), 'Password')
