...
/**
 * This tests the functionality of the Creating a New Admin with the name length to short as invalid credentials
...
//Set the Username
WebUI.setText(findTestObject('Object Repository/AdminCreateAdmin_OR/eUsername'), 'cos')
