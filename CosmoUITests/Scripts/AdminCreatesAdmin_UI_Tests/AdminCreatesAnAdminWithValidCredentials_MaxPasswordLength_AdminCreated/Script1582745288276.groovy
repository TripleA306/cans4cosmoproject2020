...
/**
 * This tests the functionality of the Creating a New Admin with the maximum passowrd length as valid credentials
...
//Set the Username
WebUI.setText(findTestObject('Object Repository/AdminCreateAdmin_OR/eUsername'), 'cosmoAdmin2')

//Set the Password
WebUI.setText(findTestObject('Object Repository/AdminCreateAdmin_OR/ePassword'), 'Passw0rd11111111111111111111111111111111')

//Confirm the Password
WebUI.setText(findTestObject('Object Repository/AdminCreateAdmin_OR/eConfirmPassword'), 'Passw0rd11111111111111111111111111111111')
