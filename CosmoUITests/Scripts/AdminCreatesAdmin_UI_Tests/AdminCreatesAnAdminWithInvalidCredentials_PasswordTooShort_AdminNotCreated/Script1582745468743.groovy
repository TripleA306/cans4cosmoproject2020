...
/**
 * This tests the functionality of the Creating a New Admin with a password that is too short as invalid credentials
...
//Set the Password
WebUI.setText(findTestObject('Object Repository/AdminCreateAdmin_OR/ePassword'), 'Secret1')

//Confirm the Password
WebUI.setText(findTestObject('Object Repository/AdminCreateAdmin_OR/eConfirmPassword'), 'Secret1')
