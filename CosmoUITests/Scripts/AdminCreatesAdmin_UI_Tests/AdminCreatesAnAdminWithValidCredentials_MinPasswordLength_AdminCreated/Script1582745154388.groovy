...
/**
 * This tests the functionality of the Creating a New Admin with the minimum passowrd length as valid credentials
...
//Set the Username
WebUI.setText(findTestObject('Object Repository/AdminCreateAdmin_OR/eUsername'), 'cosmoAdmin3')

//Set the Password
WebUI.setText(findTestObject('Object Repository/AdminCreateAdmin_OR/ePassword'), 'Secret12')

//Confirm the Password
WebUI.setText(findTestObject('Object Repository/AdminCreateAdmin_OR/eConfirmPassword'), 'Secret12')
