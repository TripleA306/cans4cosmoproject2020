...
/**
 * This tests the functionality of the Creating a New Admin with the minimum acceptable name as valid credentials
...
//Set the Username
WebUI.setText(findTestObject('Object Repository/AdminCreateAdmin_OR/eUsername'), 'cosm')
