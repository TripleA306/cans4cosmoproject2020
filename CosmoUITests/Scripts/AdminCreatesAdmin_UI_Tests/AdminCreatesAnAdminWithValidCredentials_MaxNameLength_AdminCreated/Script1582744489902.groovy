...
/**
 * This tests the functionality of the Creating a New Admin with the max name length as valid credentials
...
//Set the Username
WebUI.setText(findTestObject('Object Repository/AdminCreateAdmin_OR/eUsername'), 'cosmoAdmin123456789101827')
