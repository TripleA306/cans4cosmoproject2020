...
/**
 * This tests the functionality of the Creating a New Admin with the name length to long as invalid credentials
 * Authors: Nathan Kappel cst217, Aaron Atkinson cst201
 */
//Open the browser
//verify the Create Admin Button Exists
...
//Set the Username
WebUI.setText(findTestObject('Object Repository/AdminCreateAdmin_OR/eUsername'), 'cosmoAdmin1234567891018278')
...
WebUI.verifyTextPresent('Username must be between 4 and 25 characters', false)
