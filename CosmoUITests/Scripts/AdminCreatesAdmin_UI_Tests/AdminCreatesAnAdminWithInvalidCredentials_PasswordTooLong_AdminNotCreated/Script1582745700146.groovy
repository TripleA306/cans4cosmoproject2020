...
/**
 * This tests the functionality of the Creating a New Admin with a password that is too long as invalid credentials
...
//Set the Password
WebUI.setText(findTestObject('Object Repository/AdminCreateAdmin_OR/ePassword'), 'Passw0rd111111111111111111111111111111111')

//Confirm the Password
WebUI.setText(findTestObject('Object Repository/AdminCreateAdmin_OR/eConfirmPassword'), 'Passw0rd111111111111111111111111111111111')
...
WebUI.verifyTextPresent('Password must be between 8 and 40 characters, and include at least one Uppercase, and one digit', 
    false)
