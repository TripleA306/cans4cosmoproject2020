...
//	Region is 2 years in the past
//	This will result in three dates displaying
///////////////////////////////////////////////////////////////////////////////
//Declare a list that will be populated by the helper method
ArrayList<Date> dateList = new ArrayList<Date>()

//Set dateList equal to what our helper method returns, Pass in the date (Jan 1st, 2018) This is the same as the backends first date
dateList = CustomKeywords.'helperFunctions.SubscriberDateCalculator.GetExpectedDates'(10, new Date(118,0,0))
