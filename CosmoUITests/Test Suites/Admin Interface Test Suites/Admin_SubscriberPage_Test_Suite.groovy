...
def setUp() {
	// Put your code here.
	//open the browser
	WebUI.openBrowser("http://localhost:5002/api/webApp/reloadDB")
...
def tearDown() {
	...
	//Sends request to API to reset the DB
	WebUI.closeBrowser()
}
...
def setupTestCase() {
	// Put your code here.
	WebUI.click(findTestObject("Routes_OR/Navigation_Bar/button_NavHome"));
	WebUI.click(findTestObject("Navigation_Bar/button_Subscriber_Nav"));
}
