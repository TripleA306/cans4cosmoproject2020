...
<WebElementEntity>
   ...
   <name>btnContinueWithGoogle</name>
   <tag></tag>
   <elementGuidId>a6f592fc-abb3-492f-adde-c40a1bd6424f</elementGuidId>
   <selectorCollection>
      <entry>
         <key>XPATH</key>
         <value></value>
...
/*normal display*/
.g-signin-button[data-v-5faf54d0] {
    display: inline-block;
    padding: 4px 8px;
    min-width: 191px;
    min-height: 46px;
    border-radius: 3px;
    background-image: url(/img/btn_google_signin_dark_normal_web@2x.56f00e35.png);
    background-size: cover;
}

/*darken when button is hovered over*/
.g-signin-button[data-v-5faf54d0]:hover {
     display: inline-block;
     min-width: 191px;
     min-height: 46px;
     padding: 4px 8px;
     border-radius: 3px;
     background-image: url(/img/btn_google_signin_dark_pressed_web@2x.75a7cb04.png);
}

/*When the button is clicked lighten up*/
.g-signin-button[data-v-5faf54d0]:active {
    display: inline-block;
    min-width: 191px;
    min-height: 46px;
    padding: 4px 8px;
    border-radius: 3px;
    background-image: url(/img/btn_google_signin_dark_focus_web@2x.f41e93ec.png);
}
#login[data-v-5faf54d0]{
    text-align: center;
}
